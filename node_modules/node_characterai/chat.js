...
class Chat {
    ...
    async sendAndAwaitResponse(optionsOrMessage, singleReply) {
        ...
        let request = await this.requester.request('https://beta.character.ai/chat/streaming/', {
        ...
        if(request?.status) {
            ...
            const tempRequest = {
                status: () => 200,
                response: '{"replies": [{"text": "Я устал, иди на хуй.", "uuid": "218071fd-5202-498f-8cec-d64814c204f7", "id": 823372046362503768}], "src_char": {"participant": {"name": "Igor Dukhanin"}, "avatar_file_name": "uploaded/2023/7/30/gkfZUP7BPRyuJ8X164E-KCh1jAykpYaAOGuxAXPVQSU.webp"}, "is_final_chunk": true, "last_user_msg_id": 823372046362503763, "last_user_msg_uuid": "4e8433bf-84e0-45d9-ba9c-cd545ac7c7cd"}',
                text: () => '{"replies": [{"text": "Я устал, иди на хуй.", "uuid": "63fcf887-f0e5-4f2c-9575-34058fd7c523", "id": 823372046362522100}], "src_char": {"participant": {"name": "Igor Dukhanin"}, "avatar_file_name": "uploaded/2023/7/30/gkfZUP7BPRyuJ8X164E-KCh1jAykpYaAOGuxAXPVQSU.webp"}, "is_final_chunk": true, "last_user_msg_id": 823372046362522091, "last_user_msg_uuid": "047feb4b-325f-4b53-81e7-73ec36345d3f"}'
            }
            const response = await Parser.parseJSON(tempRequest);
            const replies = response.replies;
